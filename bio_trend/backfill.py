...
Each work is mapped to the same record schema as :mod:`bio_trend.rss`, so backfilled
...
from bio_trend.rss import RECORD_COLUMNS, strip_html

if TYPE_CHECKING:  # pragma: no cover - typing only
    import pandas as pd
    import requests

    from bio_trend.registry import Journal, JournalRegistry
...
def backfill_journal(
    ...
    *,
    ...
    from bio_trend.ingest import accumulate
