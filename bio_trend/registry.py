...
from bio_trend.taxonomy import DEFAULT_CONFIG_DIR
...
DEFAULT_JOURNALS = [
    {
        ...
        "label": "Nature",
        "family": "Nature",
        "feeds": [{"url": "https://www.nature.com/nature.rss", "type": "journal", "bio_focus": "mixed"}],
    },
]
...
class Feed:
    ...
    bio_focus: str = "mixed"  # high | mixed
        ...
        for entry in raw:
            ...
            feeds = tuple(
                Feed(
                    ...
                    bio_focus=f.get("bio_focus", "mixed"),
                )
                for f in feeds_raw
            )
            journals.append(
