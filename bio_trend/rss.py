...
This is Bio-trend's ingestion layer — the analogue of AI-trend's ``openreview.py``
...
if TYPE_CHECKING:  # pragma: no cover - typing only
    ...
    from bio_trend.registry import Journal
...
USER_AGENT = (
    ...
    "Chrome/124.0.0.0 Safari/537.36 (+bio-trend RSS reader)"
)
...
def feed_status(url: str, *, agent: str = USER_AGENT) -> tuple[bool, int, int]:
    ...
    entry. Used by ``bio-trend check-feeds``.
    """
